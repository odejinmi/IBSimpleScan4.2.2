...
*
* @li @par  2022/02/18
*						Modified enumeration name change from\n
...
*                 		Added callback for detecting the key button of device that was pressed.
*
* @li @par  2015/08/07
...
*
* @li @par  2014/06/19
*						The method toBitmapScaled was extended to support the thickness of rolling guide line.
*
* @li @par  2014/02/25
...
public class IBScanDevice
{
	...
	*/
    public static enum PropertyId
    {
        ...
        * Some devices (or firmware versions) do not support this feature.
        */
        ENABLE_DECIMATION(22),

        /**
        * [get/set] Enable capture on release (TRUE to enable or FALSE to disable). The default is FALSE.
        * TRUE  : The result callback will be called when the user releases the finger from the sensor.
        * FALSE : The result callback will be called when the quality of finger becomes good
        */
        ...
        */
        ...
        /**
        * [get] The device ID which shares information with the UsbDevice class from Android.
	    */
		DEVICE_ID(25),
	
		/** [get/set] Can be used for dry fingers
	    * Some devices (or firmware versions) do not support this feature.
	    ...
	    */
		...
		/**  [Get and set.] Minimum capture time when dry mode is enabled with the property ENUM_IBSU_PROPERTY_SUPER_DRY_MODE
	    * Some of device (or firmware versions) do not support this feature.
	    * The valid range is between 600- and 3000-ms, 
	    * inclusive, with a default of 2000-ms. 
	    */
        ...
        * The default is TRUE.  [Get and set.] */
        ...
        /** Enable to override a roll image (TRUE to enable or FALSE to disable). 
        * The default is FALSE.  [Get and set.] */
        ROLL_IMAGE_OVERRIDE(31),

	    /** Enable a warning message for invalid area for the result image (TRUE to enable or FALSE to disable). 
        * The default is FALSE.  [Get and set.] */
       ...
       * The default is FALSE.  [Get and set.] */
	    ...
	    /** Check if the device supports spoof function or not */
		...
		* The default value of 3 should be used as baseline level/sensitivity when tuning application performance.
		*
		...
		* is fake, or a spoof. This feature is designed so that the algorithm returns a warning callback when a
		* spoof is detected */
		SPOOF_LEVEL(42),
	    ...
	    * The default value is 0.  [Get and set.] 
		* 0 : No use
		* 1 : renewal if roll image is moved 1.2mm.
		* 2 : renewal if roll image is moved 2.4mm.
		* 3 : renewal if roll image is moved 3.6mm.
		*/
		RENEWAL_OPPOSITE_IMGAE_LEVEL(46),
	
		/**
		* Enable High quality preview images for Kojak
	    * The default value is 0.  [Get and set.] */
        ...
        * The default value is FALSE.  [Get and set.] */
		...
		/** 
		* Enable Zoom-In mode : It sets Zoom-In when fingers are detected in DR mode.
		* The default value is TRUE.  This property can only be set FALSE in WINDOWS.
		...
		* The default value is dependant on the scanner.  [Get and set.] */
		RESERVED_CAPTURE_BRIGHTNESS_THRESHOLD_FOR_FLAT(402),

		/**
		* Change brightness threshold for roll captures.
		* The default value depends on the scanner.  [Get and set.] */
	    ...
	    * The default value is 3. The Ragne is from 1 to 10.  [Get and set.] */
		...
		* The valid range is between 0 and 1000. The default is "782"  [Get and set.]
		* 782 : default value */
    ...
    * 
    * 			This is an enumeration of the image types supported by the SDK Particular scanner models
	...
	*/
    public static enum ImageType
    {
        ...
        */
        ...
        /**
        * Rolled fingerprint image. The number of fingers in result image: 1
        */
        ROLL_SINGLE_FINGER(1, "One-finger rolled fingerprint"),
        /**
        * Flat single finger. The number of fingers in result image: 1
        */
	...
	*/
    public static enum LedType
    {
        ...
        */
        NONE(0),
        /**
        * For two finger scanner type e.g. Watson
        */
        TSCAN(1),
        
	    /**
        * For four finger scanner type (e.g., Kojak)
        */
        FSCAN(2);
	...
	*/
    ...
    {
        /**
        * Parameters for drawing a rolling line on bitmap.
        */
        ...
        /**
        * Parameters for drawing a quality arrow on bitmap.
        */		
        ...
        */
        public Bitmap toBitmap()
        {
    		...
    		if (bitmap != null)
    		{
            	 ...
            	 * It will be flipped to compensate while moving the image into the buffer. 
            	 */
        ...
        /**
        * Create a scaled image from the image data.
        * 
        ...
        */
        ...
        /**
        * @brief	Create a scaled image from the image data with rolling line.
        * 
        * @param	dstWidth		width of scaled image
        * @param	dstHeight		height of scaled image
        * @param	rollingState	state of the rolling acquisition
        * @param	rollingLineX	x-coordinate of the rolling line
        * @return	[Bitmap]		image if successful; otherwise null
        */
        ...
        /**
        * @brief	Create a scaled image from the image data with finger quality state indicator.
        * 
        * @param	dstWidth	width of scaled image
        * @param	dstHeight	height of scaled image
        ...
        * @param	rollingState		state of the rolling acquisition
        * @param	rollingLineX		x-coordinate of the rolling line
        * @param 	rollingLineWidth	thickness of the rolling line
        * @param	top					indicates whether invalid arrow should be drawn on top edge
        * @param	left				indicates whether invalid arrow should be drawn on left edge
        * @param	right				indicates whether invalid arrow should be drawn on right edge
        * @return	[Bitmap]			image if successful; null otherwise
    ...
    */
    ...
    /**
    * @brief	Set the Light-Emitting (LE) film operation mode (On, Off, or Auto) on the device.
    * 
    ...
    * 
    * @return 	[Object[]] an array containing information about the captured image. The contents of the returned 
    *         	array in order, are:
    *         	<p>
    ...
    */
    ...
    /**
    * @brief	Capture an image from the scanner, returning extended information.
    * 
    ...
    * @return 	[Object] output data will be received as IBSM_StandardFormatData
    * @throws 	IBScanException
    */
    ...
    */
    ...
    /**
    * @brief	Call C language write function via JNI
    * 
    * @param	compressedImage		WSQ-encoded image.
    * @param	compressedLength	Length of WSQ-encoded image.
   ...
   public int generateZoomOutImageEx(byte[] image, int inWidth, int inHeight, byte[]outImage,int outWidth,
    ...
    /**
    * @brief	Generate an enhanced image from preview, returning extended information.
    * 
    ...
    */
	...
	/**
    * @brief	Add a finger image for the fingerprint duplicate check and roll to slap comparison.
    ...
    */
    ...
    /**
    * @brief	Detect if the finger print is Live or Fake.
    * 
