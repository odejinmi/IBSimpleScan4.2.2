...
* @li @par  2025/06/25
*                       Added method destructor()
*                       to explicitly invoke the IBScanUltimate native destructor on Android.
*
* @li @par  2024/05/23  
...
* 			<p>
* 			The single instance of this class can be retrieved with getInstance(). The application \n
...
* 			either the blocking openDevice() method or the non-blocking openDeviceAsync()\n
...
public class IBScan
{
	...
	*/
    ...
    /**
    * @brief    Enables or disables trace log in native library.  The trace log is enabled by default.
    *
    ...
    public void requestPermission(final int deviceId)
    {
    	...
    	{  	
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                /*
                 * WARNING: As per Google's current security recommendations, the `Immutable` flag was initially applied.
                 * However, due to a limitation where the granted intent is not properly received, it has been changed to `Mutable`.
                 *
                 * IMPORTANT:
                 * - This implementation introduces potential security risks by making the PendingIntent mutable.
                 * - This change is TEMPORARY and may need to be reverted or revised if Google updates its policies.
                 */
    ...
    */
     ...
     */
    /**
    * @breif	Retrieve detailed device information about a particular scanner by logical index.
    * 
    * @param 	deviceIndex  zero-based index of the device
    ...
    */
    ...
    /**
    * @breif	Initialize device, given by a particular device index. This function blocks until an error
    ...
    */
    ...
    /**
    * @brief	Initialize device asynchronously, given by a particular device index. This function returns
    ...
    */
    ...
    /**
     * @brief   - Android Only\n
     *          Should be called in Android app's onDestroy() 
     *	        to clean up all resources used by the IBScanUltimate SDK.
     *
     * @throws	IBScanException
     */
    public void destructor() throws IBScanException
    {
        final NativeError error    = new NativeError();
        destructorNative(error);
        handleError(error); /* throws exception if necessary */
    }
    ...
    * 			This must be performed on the locked device before opening the device
    *
    * @param  	deviceIndex  zero-based index of the device
    ...
    public static boolean isScanDevice(final UsbDevice device)
    {
	    ...
	    if (vendorId == VID_IB || vendorId == VID_DERMALOG)
	    {
	        int[] productIds = { PID_CURVE, PID_WATSON, PID_WATSON_REV1, PID_SHERLOCK, PID_SHERLOCK_AUO, 
					...
					PID_KOJAK_DERMALOG, PID_COLUMBO_MINI, PID_MANNIX, PID_COLUMBO_MINI_NON_UVC};
    ...
    */
    ...
    private static final int PID_COLUMBO_MINI_NON_UVC = 0x1E00;
    ...
    */
    ...
    /** @brief	Native method for destructor(). */
    private native void destructorNative(NativeError error);
